                    ...
                    <div class="flex flex-col bg-gradient-to-r from-slate-200 to-slate-100 border shadow-sm rounded-lg">
                        <div class="p-4 md:p-5">
                            ...
                            <div class="mt-10 grid lg:grid-cols-2 gap-6">
                                ...
                                <input type="hidden" id="id_dprd1" name="id_dprd1" />
                                <div>
                                ...
                                <div>
                                    <button id="submitData" name="submitData" v-on:click="SubmitUpdateDataCalegDprd1"
...
export default {
    ...
    methods: {
        ...
        async UpdateCalegDprd1() {
            this.id = this.$route.params.id;

            await axios
                .get(`http://localhost:8080/findcalegdprd1/${this.id}`, {
                    Headers: {
                ...
                .then((response) => {
                    ...
                    document.getElementById("propinsi").value =
                        this.hasilupdate.data.propinsi;
                    document.getElementById("kode_propinsi").value =
                        this.hasilupdate.data.kode_propinsi;

                    document.getElementById("id_dprd1").value =
                        this.hasilupdate.data.id_dprd1;

                    document.getElementById("tanggal_lahir").value =
                        this.hasilupdate.data.tanggal_lahir;
                    ...
                    document.getElementById("pendidikan").value =
                        this.hasilupdate.data.pendidikan;
                    document.getElementById("jeniskelamin").value =
                        this.hasilupdate.data.jeniskelamin;
                    document.getElementById("alamat").value =
                        this.hasilupdate.data.alamat;
                    document.getElementById("tempat_lahir").value =
                        this.hasilupdate.data.tempat_lahir;
                    ...
                    document.getElementById("pekerjaan").value =
                        this.hasilupdate.data.pekerjaan;
                });
        },

        async SubmitUpdateDataCalegDprd1() {
            if (this.hasilupdate.data.id_registrasi == this.cookies.get("id")) {
                ...
                const m_id_dprd1 = document.getElementById("id_dprd1").value;
                ...
                await axios
                    .post(`http://localhost:8080/updatecalegdprd1`, this.formValues, {
                        Headers: {
                            "Content-Type": "application/x-www-form-urlencoded",
                        },
                    })
