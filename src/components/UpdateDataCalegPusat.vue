            ...
            <div class="mt-10 grid lg:grid-cols-2 gap-6">
              <div>
                ...
                <div id="listPropinsi" name="listPropinsi" v-if="mapBoxSearchResult"
                  ...
                  <p @click="IsiInput(resultKu.nama, resultKu.id)" v-for="resultKu in mapBoxSearchResult.data"
                    :key="resultKu.id"
        ...
        <div class="flex flex-col bg-gradient-to-r from-slate-200 to-slate-100 border shadow-sm rounded-lg">
          <div class="p-4 md:p-5">
            ...
            <div class="mt-10 grid lg:grid-cols-2 gap-6">
              ...
              <div>
                <label for="nohp" class="text-gray-800 text-sm font-medium block mb-2">Kontak HP/WA Caleg</label>
                <input type="number" id="nohp"
                  class="form-input py-3 px-4 block w-full border-gray-200 rounded-md text-sm focus:border-blue-500 focus:ring-blue-500" />
              </div>
              <div>
                <label for="alamat" class="text-gray-800 text-sm font-medium block mb-2">Alamat Caleg DPR RI</label>
              ...
              <div>
                <label for="pendidikan" class="text-gray-800 text-sm font-medium block mb-2">Pendidikan</label>
              ...
              <input type="hidden" id="id_dprri" name="id_dprri">
              <div>
                <label for="jeniskelamin" class="text-gray-800 text-sm font-medium block mb-2">Jenis Kelamin</label>
              ...
              <div>
                <label for="tempat_lahir" class="text-gray-800 text-sm font-medium block mb-2">Tempat Lahir</label>
                <input type="text" id="tempat_lahir"
                  class="form-input py-3 px-4 block w-full border-gray-200 rounded-md text-sm focus:border-blue-500 focus:ring-blue-500" />
              </div>
              <div>
                <label for="tanggal_lahir" class="text-gray-800 text-sm font-medium block mb-2">Tanggal Lahir</label>
              ...
              <div>
                <label for="pekerjaan" class="text-gray-800 text-sm font-medium block mb-2">Pekerjaan</label>
  ...
  methods: {
    ...
    async SubmitDataCalegPusat() {
      ...
      if (this.hasilupdate.data.id_registrasi == this.cookies.get('id')) {
        ...
        const m_id_dprri = document.getElementById("id_dprri").value;
        ...
        await axios.post(
          `http://localhost:8080/updatecalegpusat`,
          this.formValues,
          {
            Headers: {
    ...
    async UpdateCalegPusat() {
      this.id = this.$route.params.id;

      await axios.get(
        `http://localhost:8080/findcalegpusat/${this.id}`,
        {
          Headers: {
            "Content-Type": "application/x-www-form-urlencoded",
          },
        ...
        document.getElementById("id_dprri").value = this.hasilupdate.data.id_dprri;
