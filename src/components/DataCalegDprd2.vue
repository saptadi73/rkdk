    ...
    <div
      ...
      <nav class="flex space-x-2" aria-label="Tabs" role="tablist">
        ...
        <button type="button"
          ...
          Data Diri Caleg Kota/Kabupaten
        </button>
    ...
    <div id="segment-2" class="hidden" role="tabpanel" aria-labelledby="segment-item-2">
      <div class="flex flex-col gap-6">
        <div class="flex flex-col bg-gradient-to-r from-slate-200 to-slate-100 border shadow-sm rounded-lg">
          <div class="p-4 md:p-5">
            <h3 class="text-lg font-bold text-black dark:text-white">
              Pengisian Data Diri Caleg Kota/Kabupaten
            </h3>
            <div class="mt-10 grid lg:grid-cols-2 gap-6">
              <div>
              ...
              <div>
                <label for="alamat" class="text-gray-800 text-sm font-medium block mb-2">Alamat Caleg</label>
              ...
              <div>
                <button
                  ...
                  v-on:click="SubmitDataCalegDprd2">
                  Simpan Data
                </button>
              </div>
            </div>
  ...
  queryTimeOut.value = setTimeout(async () => {
    try {
      const ResultKota = await axios.post(
        `http://localhost:8080/inputcalegdprd2`, formValues, {
        Headers: {
