        ...
        <div class="flex flex-col bg-gradient-to-r from-slate-200 to-slate-100 border shadow-sm rounded-lg">
          <div class="p-4 md:p-5">
            ...
            <div class="mt-10 grid lg:grid-cols-2 gap-6">
              <div>
                <label for="propinsi">Pilih Provinsi</label>
                <div class="flex">
        ...
        <div class="flex flex-col bg-gradient-to-r from-slate-200 to-slate-100 border shadow-sm rounded-lg">
          <div class="p-4 md:p-5">
            ...
            <div class="mt-10 grid lg:grid-cols-2 gap-6">
              ...
              <div>
                <label for="situs" class="text-gray-800 text-sm font-medium block mb-2">Situs Resmi Partai</label>
              ...
              <button id="simpan_data"
                ...
                v-on:click="submitDataPartaiPropinsi">Simpan Data</button>
            </div>
          </div>
        </div>
      </div>
...
const submitDataPartaiPropinsi = () => {
  ...
  queryTimeOut.value = setTimeout(async () => {
    try {
      const ResultKota = await axios.post(
        `http://localhost:8080/inputpartaipropinsi`, formValues, {
        Headers: {
